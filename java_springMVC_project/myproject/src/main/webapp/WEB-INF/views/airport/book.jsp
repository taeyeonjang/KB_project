		...
		<div class="container-fluid">
			<div style="display: flex; width: 200px">
				<a href="MainPage" class="navbar-brand"><h2
						style="font-weight: 800; display: flex;">티켓 컴바인</h2> </a> <img
	...
	<c:forEach var="item" items="${data }">
		...
		<div class="card mb-3"
			...
			<button style="height: 50px; background-color: tomato;"
				onclick="location.href='bookCheck?ticketnum=${item.get('ticketnum')}&id=${sessionId }&publeYear=${publeYear}'">
				<h3 style="line-height: 45px;">예매하기</h3>
			</button>
